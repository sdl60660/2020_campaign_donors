 ...
 (SELECT donors_grouped.fec_id,
   ...
   FROM ( SELECT candidates.fec_id,
          ...
          WHERE contributions.candidate IS NOT NULL AND candidates.district_id <> donors_with_expected_demographics.house_district_id AND candidates.district_id <> donors_with_expected_demographics.senate_district_id AND donors_with_expected_demographics.median_household_income IS NOT NULL
